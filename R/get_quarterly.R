#' Get data on quarterly market expectations for economic indicators (Focus/BCB)
#'
...
#' @param reference_date A single string in "q/YYYY" format, indicating the reference quarter and year for which the statistic is expected. Defaults to NULL.
...
#'
#' Possible values for indicator argument: "PIB Agropecuária", "PIB Industrial", "PIB Serviços", "PIB Total".
